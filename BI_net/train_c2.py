...
if __name__ == "__main__":
    ...
    Exper_name = 'Biformer'
    fold_path_name_list = ['f1']      # "f1", 'f2', 'f4', 'f5'
    target_name: str = ''
    ...
    fold_stop = 3  # int,如果只是训练单折被异常终止，则此处为0，如果为K折，则此处为中断的那一折数字
    RESUME = ''
    if resume_model:
